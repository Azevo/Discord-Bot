...
@client.command(name="toca", help="Toca uma musica através de seu título, pesquisado no youtube")
    ...
    for video_id in video_ids:
        with youtube_dl.YoutubeDL(ydl_opts) as ydl:
            ...
            if len(titulos) == 5:
                ...
                YDL_OPTIONS = YDL_OPTIONS = {'format': 'bestaudio/best','postprocessors': [{'key': 'FFmpegExtractAudio','preferredcodec': 'mp3','preferredquality': '192',}],}
